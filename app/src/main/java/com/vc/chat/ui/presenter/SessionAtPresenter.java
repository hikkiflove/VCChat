...
import com.vc.chat.model.data.LocationData;
import com.vc.chat.model.message.RedPacketMessage;
import com.vc.chat.ui.activity.SessionActivity;
import com.vc.chat.ui.activity.ShowBigImageActivity;
import com.vc.chat.ui.adapter.SessionAdapter;
import com.vc.chat.ui.base.BaseFragmentActivity;
import com.vc.chat.ui.base.BaseFragmentPresenter;
import com.vc.chat.ui.view.ISessionAtView;
import com.vc.chat.util.FileOpenUtils;
import com.vc.chat.util.LogUtils;
import com.vc.chat.util.MediaFileUtils;
import com.vc.chat.util.RedPacketUtil;
...
public class SessionAtPresenter extends BaseFragmentPresenter<ISessionAtView> {
    ...
    com.yunzhanghu.redpacketsdk.RPSendPacketCallback RPSendPacketCallback = new RPSendPacketCallback() {
        @Override
